<%-- 
    Document   : modify
    Created on : 9 Apr, 2018, 10:24:31 PM
    Author     : dnyaneshwar
--%>
...
<br><br><br><br><br>
<%
       String select= request.getParameter("sub");
       ...
       resultset = statement.executeQuery("select mid,a_name,date,domain,a_file,a_size,s_time1,time_sec1,s_time2,time_sec2,s_time3,time_sec3,cmp from m_content where mid='"+select+"' ");
                ...
                <div class="row">                    
                    ...
                    <div class="col-md-8">
                        <div class="formContainer">
                            <h5>Modify Your Data</h5>
                            <form id="registerForm" class="form-horizontal" method="post" action="modify-process.jsp"  >
...
<input type="hidden" name="zoo_visitor_error_delimiters" value=""><input type="hidden" name="AG" value="B4UuBMveuATKIE+whI14SoE0m71bINpXlf4J+HVA43E="><input type="hidden" name="autologin" value=""><input type="hidden" name="zoo_visitor_action" id="zoo_visitor_action" value="register"> 
                          <input type="hidden" name="id" value="<%=resultset.getString(1) %>">
                                ...
                                <div class="col-sm-6">                      
                                    <div class="form-group">
                                        <label for="member_firstname" class="col-sm-4 control-label">Date:<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                            <input id="member_firstname" name="dm" type="date" class="form-control" value="<%=resultset.getString(3) %>" required/>
                                        </div>
                                    </div>                        
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="member_lastname" class="col-sm-4 control-label">Domain:<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                            <input id="member_lastname" name="dm" type="text" class="form-control" value="<%=resultset.getString(4) %>" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="email" name="ad" type="text" class="form-control" value="<%=resultset.getString(2) %>" required/>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="member_mobile" name="adf" type="text" class="form-control" value="<%=resultset.getString(5)%>" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input  name="s" type="text" class="form-control" value="<%=resultset.getString(6) %>" required/>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="cmp" type="text" class="form-control" value="<%=resultset.getString(13) %>" required/>
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="st1" type="text" class="form-control" value="<%=resultset.getString(7) %>" required/>
                                        </div>
                                    </div> 
                                </div>
                         ...
                         <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="t1" type="text" class="form-control" value="<%=resultset.getString(8) %>" required/>
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="st2" type="text" class="form-control" value="<%=resultset.getString(9) %>"/>
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="t2" type="text" class="form-control"  value="<%=resultset.getString(10) %>" />
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="st3" type="text" class="form-control" value="<%=resultset.getString(11) %>" />
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="t3" type="text" class="form-control" value="<%=resultset.getString(12) %>" />
                                        </div>
                                    </div> 
                                </div>
                            </div>
                                    ...
                                    <div class="checkbox">
                                        <label class="control-label">
                                            <input type='checkbox' name='accept_terms' value='y'  required/> 
                                                   I agree with the <a href="https://nerolac.com/terms-and-conditions.html" target="_blank">terms and conditions</a>. </label>
                                    </div>
                                    <label id="accept_terms-error" class="error" for="accept_terms" style="display:none">This field is required.</label>
                                </div>
                            </div>
<button type="submit" class="custom-btn btn-anim"><span>Submit</span></button>&nbsp<button type="reset" class="custom-btn btn-anim"><span>Clear</span></button></form><script type="text/javascript" charset="utf-8">// <![CDATA[ 
