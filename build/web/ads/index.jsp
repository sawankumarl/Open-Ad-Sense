...
Countly.url = "https://bolanalytics.rediff.com"; 
Countly.debug = true;
            ...
            <div class="slides">             
                <div class="slide" >                    
                    <div class="contentHolder">
                        <div class="contentHolderIns" style="background-image:url(images/40.jpg);"> <img src="images/40.jpg" alt="Nerolac Home Paints" title="Nerolac Home Painting Design" class="hide" />
                          
                        </div>
                    </div>
                </div><div class="slide" >                    
                    <div class="contentHolder">
                        <div class="contentHolderIns" style="background-image:url(images/act.jpg);"> <img src="images/act.jpg" alt="Nerolac Impressions" title="Nerolac Impressions Eco Clean" class="hide" />
                           
                        </div>
                    </div>
                </div><div class="slide" >                    
                    <div class="contentHolder">
                        <div class="contentHolderIns" style="background-image:url(images/big_data.jpg);"> <img src="images/big_data.jpg" alt="Nerolac Home Paints" title="Nerolac Home Paints" class="hide" />
                           
                        </div>
                    </div>
                </div><div class="slide" >                    
                    <div class="contentHolder">
                        <div class="contentHolderIns" style="background-image:url(images/ad.jpg);"> <img src="images/ad.jpg" alt="Nerolac  4 Color Scheme" title="Nerolac Home Paint Colors " class="hide" />
...
<section class="sectionWrapper">	      
    	...
    	<h5>in your wall decor journey</h5>
    <br><br><br>
    <div class="container">
        <div class="col-md-6 col-lg-6">
            <div class="row"> 
                <!-- BLUE SECTION Starts-->
                <div class="starter-tile custom-viewport" anim-class="active" elem-offset-prcnt="25" elem-class=".custom-column" repeat="true"> 
               
                    <div class="col-sm-6 custom-column blue right viewport" style="background-color:#00afbd;">
                        <div class="row">
                            <div class="square-wrapper media-table">
                                <div class="media-body media-middle">                                    
                                        <h2>The <span>Inspirator</span></h2>
                                        <p><p>Google</p></p>
                                        <a href="https://www.google.com.tw" class="custom-btn btn-anim"><span>Google</span></a> </div>                                     
                            </div>

                            <!--triangle-->
                            <div class="triangle-wrapper right">
                                <div class="triangle">
                                	<span class="after" style="border-left-color:#00afbd;"></span>
                                </div>
                                <div class="lines"> </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="row">                            
                            <div class="square-wrapper bgImageWrapper lazy" data-src="images/g.gif"> </div>
                        </div>
                    </div>
                  <div class="clearfix"></div>
                </div>
                <div class="starter-tile custom-viewport" anim-class="active" elem-offset-prcnt="25" elem-class=".custom-column" repeat="true"> 
                  <div class="col-sm-6 col-sm-push-6 custom-column green left viewport" style="background-color:#62B546;">
                        <div class="row">
                            <div class="square-wrapper media-table">
                                <div class="media-body media-middle">                                                                        
                                    	<h2> <span>The Trends</span></h2>
                                    	<p><p>You Tube</p></p>                                   
                                    	<a href="https://www.youtube.com/" class="custom-btn btn-anim"><span>You Tube</span></a> </div>                                    
                            </div>            
                            <div class="triangle-wrapper left">
                                <div class="triangle">
                                	<span class="after" style="border-right-color:#62B546;"></span>
                                </div>
                                <div class="lines"> </div>
                            </div>
                        </div>
              ...
              <div class="col-sm-6 col-sm-pull-6">
                        <div class="row">                            
                            <div class="square-wrapper bgImageWrapper lazy" data-src="images/youtube.gif"> </div>
                        </div>
                    </div>
                   <div class="clearfix"></div>
                </div>
        ...
        <div class="col-md-6 col-lg-6">
            <div class="row"> 
                <div class="starter-tile custom-viewport" anim-delay=".25" anim-class="active" elem-offset-prcnt="25" elem-class=".custom-column" repeat="true"> 
                   <div class="col-sm-6 custom-column yellow right viewport" data-wow-delay=".25s" style="background-color:#eab81f;">
                        <div class="row">
                            <div class="square-wrapper media-table">
                                <div class="media-body media-middle">                                                                        
                                    	<h2>Pick Your <span>Friends</span></h2>
                                    	<p><p>Facebook</p></p>                                   
                                    	<a href="https://www.facebook.com/" class="custom-btn btn-anim"><span>Find</span></a> </div>                                     
                            </div>
                        </div>
                    </div>                    
                  <div class="col-sm-6">
                        <div class="row">                            
                            <div class="square-wrapper bgImageWrapper lazy" data-src="images/Facebook.gif"> </div>
                        </div>
                    </div>
                  <div class="clearfix"></div>
                </div>
                <div class="starter-tile custom-viewport" anim-delay=".25" anim-class="active" elem-offset-prcnt="25" elem-class=".custom-column" repeat="true"> 
                  <div class="col-sm-6 col-sm-push-6 custom-column orange left viewport" data-wow-delay=".25s" style="background-color:#E85624;">
                        <div class="row">
                            <div class="square-wrapper media-table">
                                <div class="media-body media-middle">                                                                        
                                    <h2> <span>The Experts</span></h2>
                                    <p><p>Yahoo</p></p>                                    
                                    <a href="https://in.yahoo.com/" class="custom-btn btn-anim"><span>Pick One</span></a> </div>                                
                            </div>
                          <div class="triangle-wrapper left">
                                <div class="triangle">
                                	<span class="after" style="border-right-color:#E85624;"></span>
                                </div>
                                <div class="lines"> </div>
                            </div>
                        </div>
                     ...
                     <div class="col-sm-6 col-sm-pull-6">
                        <div class="row">                            
                            <div class="square-wrapper bgImageWrapper lazy" data-src="images/Yahoo-UK.png"> </div>
                        </div>
                    </div>
                  <div class="clearfix"></div>
                </div>
...
<input type="hidden" name="params_id" value="8882982" />
<input type="hidden" name="csrf_token" value="45fc81fb42d0ae72f9e7a900210a6bcdfed901c3" />
</div>  
...
<ul class="list-inline"><li> <a href="index.jsp">Home</a></li><li> <a href="" >Privacy Policy</a></li><li> <a href="" >Terms & Conditions</a></li><li> <a href="" >Quality Policy</a></li><li> <a href="" >Site Map</a></li>
</ul>
